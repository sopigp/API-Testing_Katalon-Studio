...
WS.sendRequest(findTestObject('REST Service/Single_Users'))

response = WS.sendRequestAndVerify(findTestObject('REST Service/Single_Users'))
...
response3 = WS.getElementPropertyValue(response, 'data.email')

println('email single untuk register :' + GlobalVariable.email_register)
